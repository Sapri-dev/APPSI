...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        View::composer(['layouts.*', 'components.*', 'pages.*', 'admin.*'], function ($view) {
            $view->with([
                'appsiLogo'        => Pengaturan::logo(),
                'appsiEmblem'      => Pengaturan::emblem(),
                'appsiPeriode'     => Pengaturan::get('periode', '2025–2029'),
                'pengaturanSosmed' => [
